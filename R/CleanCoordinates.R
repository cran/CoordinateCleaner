...
CleanCoordinates <- function(x, 
  ...
  out <- clean_coordinates(x = x, lat = lat, lon = lon, 
                           countries = countries, tests = tests,
                           capitals_rad = capitals.rad, 
                           centroids_rad = centroids.rad,
                           centroids_detail = centroids.detail, 
                           inst_rad = inst.rad,
                           outliers_method = outliers.method, 
                           outliers_mtp = outliers.mtp,
                           outliers_td = outliers.td, 
                           outliers_size = outliers.size,
                           zeros_rad = zeros.rad, 
                           capitals_ref = capitals.ref, 
